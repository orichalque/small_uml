...
public class SmallumlFactoryImpl extends EFactoryImpl implements SmallumlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SmallumlPackage.BOOL: return createBool();
			...
			case SmallumlPackage.COMPOSITION: return createComposition();
			case SmallumlPackage.REFERENCE: return createReference();
