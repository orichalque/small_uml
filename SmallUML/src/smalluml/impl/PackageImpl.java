 ...
 * </p>
 * <ul>
 *   <li>{@link smalluml.impl.PackageImpl#getMember <em>Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends NamedElementImpl implements smalluml.Package {
	...
	public EList<NamedElement> getMember() {
		if (member == null) {
			member = new EObjectContainmentEList<NamedElement>(NamedElement.class, this, SmallumlPackage.PACKAGE__MEMBER);
		}
		return member;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmallumlPackage.PACKAGE__MEMBER:
