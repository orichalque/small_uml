		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassAccess().getAlternatives_4_1(), "rule__Class__Alternatives_4_1");
					...
					put(grammarAccess.getCompositionAccess().getGroup_0(), "rule__Composition__Group_0__0");
					put(grammarAccess.getReferenceAccess().getGroup(), "rule__Reference__Group__0");
					put(grammarAccess.getReferenceAccess().getGroup_0(), "rule__Reference__Group_0__0");
					...
					put(grammarAccess.getClassAccess().getMethodAssignment_4_1_0(), "rule__Class__MethodAssignment_4_1_0");
					put(grammarAccess.getClassAccess().getAttributeAssignment_4_1_1(), "rule__Class__AttributeAssignment_4_1_1");
					...
					put(grammarAccess.getCompositionAccess().getNameAssignment_0_0(), "rule__Composition__NameAssignment_0_0");
					put(grammarAccess.getCompositionAccess().getSourceAssignment_1(), "rule__Composition__SourceAssignment_1");
					put(grammarAccess.getCompositionAccess().getTargetAssignment_3(), "rule__Composition__TargetAssignment_3");
					put(grammarAccess.getReferenceAccess().getNameAssignment_0_0(), "rule__Reference__NameAssignment_0_0");
					put(grammarAccess.getReferenceAccess().getSourceAssignment_1(), "rule__Reference__SourceAssignment_1");
					put(grammarAccess.getReferenceAccess().getTargetAssignment_3(), "rule__Reference__TargetAssignment_3");
					put(grammarAccess.getRoleAccess().getNameAssignment_0(), "rule__Role__NameAssignment_0");
					put(grammarAccess.getRoleAccess().getClassAssignment_2(), "rule__Role__ClassAssignment_2");
					put(grammarAccess.getRoleAccess().getLowerBoundAssignment_3_2(), "rule__Role__LowerBoundAssignment_3_2");
					put(grammarAccess.getRoleAccess().getUpperBoundAssignment_3_4(), "rule__Role__UpperBoundAssignment_3_4");
					put(grammarAccess.getEnumerationAccess().getNameAssignment_2(), "rule__Enumeration__NameAssignment_2");
					put(grammarAccess.getEnumerationAccess().getValuesAssignment_4(), "rule__Enumeration__ValuesAssignment_4");
					put(grammarAccess.getEnumerationAccess().getValuesAssignment_5_1(), "rule__Enumeration__ValuesAssignment_5_1");
				}
			};
		}
