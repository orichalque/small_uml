...
public class SMallUMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Attribute(ISerializationContext context, Attribute semanticObject) {
		...
		feeder.accept(grammarAccess.getAttributeAccess().getTypeTypeParserRuleCall_4_0(), semanticObject.getType());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString super=[Class|EString]? (method+=Method method+=Method*)? (attribute+=Attribute attribute+=Attribute*)? (role+=Role role+=Role*)?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=EString upperBound=EInt? lowerBound=EInt? (role+=[Role|EString] role+=[Role|EString]*)?)
	 */
	...
	protected void sequence_Parameter(ISerializationContext context, smalluml.Parameter semanticObject) {
		...
		feeder.accept(grammarAccess.getParameterAccess().getTypeTypeParserRuleCall_4_0(), semanticObject.getType());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString relation=[Relation|EString])
	 */
	protected void sequence_Role(ISerializationContext context, Role semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SmallumlPackage.Literals.NAMED_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SmallumlPackage.Literals.NAMED_ELEMENT__NAME));
			if (transientValues.isValueTransient(semanticObject, SmallumlPackage.Literals.ROLE__RELATION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SmallumlPackage.Literals.ROLE__RELATION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRoleAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getRoleAccess().getRelationRelationEStringParserRuleCall_4_0_1(), semanticObject.getRelation());
		feeder.finish();
	}
